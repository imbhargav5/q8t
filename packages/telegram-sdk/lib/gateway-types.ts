...
export interface CheckVerificationStatusResponse {
  ...
  delivery_status?: { sent_at?: number; delivered_at?: number; read_at?: number; expired_at?: number };
  verification_status?: { verified?: boolean; verified_at?: number; attempts?: number };
}
...
export interface ErrorResponse {
  ok: boolean;
  error: { code?: "INVALID_PHONE_NUMBER" | "PHONE_NUMBER_BANNED" | "RATE_LIMIT_EXCEEDED" | "INVALID_REQUEST_ID" | "REQUEST_NOT_FOUND" | "INSUFFICIENT_BALANCE" | "INVALID_ACCESS_TOKEN" | "INVALID_TTL" | "INVALID_CODE_LENGTH"; message?: string };
}
