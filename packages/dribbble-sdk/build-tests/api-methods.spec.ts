...
describe("DribbbleApi - Method Existence", () => {
  ...
  describe("Method Signatures", () => {
    it("getAuthenticatedUser should return a promise", async () => {
      const result = api.getAuthenticatedUser();
      expect(result).toBeInstanceOf(Promise);
    });

    it("listUserShots should accept optional params", async () => {
      const result = api.listUserShots({ page: 1, per_page: 30 });
      expect(result).toBeInstanceOf(Promise);
    });

    it("getShot should accept id parameter", async () => {
      const result = api.getShot(123);
      expect(result).toBeInstanceOf(Promise);
    });

    it("createShot should accept FormData", async () => {
      const formData = new FormData();
      const result = api.createShot(formData);
      expect(result).toBeInstanceOf(Promise);
    });

    it("updateShot should accept id and body", async () => {
      const result = api.updateShot(123, { title: "Updated" });
      expect(result).toBeInstanceOf(Promise);
    });

    it("deleteShot should accept id parameter", async () => {
      const result = api.deleteShot(123);
      expect(result).toBeInstanceOf(Promise);
    });

    it("createAttachment should accept shot_id and FormData", async () => {
      const formData = new FormData();
      const result = api.createAttachment(123, formData);
      expect(result).toBeInstanceOf(Promise);
    });

    it("deleteAttachment should accept shot_id and id parameters", async () => {
      const result = api.deleteAttachment(123, 456);
      expect(result).toBeInstanceOf(Promise);
    });

    it("listUserProjects should accept optional params", async () => {
      const result = api.listUserProjects({ page: 1, per_page: 50 });
      expect(result).toBeInstanceOf(Promise);
    });

    it("createProject should accept body parameter", async () => {
      const result = api.createProject({ name: "New Project" });
      expect(result).toBeInstanceOf(Promise);
    });

    it("updateProject should accept id and body", async () => {
      const result = api.updateProject(123, { name: "Updated Project" });
      expect(result).toBeInstanceOf(Promise);
    });

    it("deleteProject should accept id parameter", async () => {
      const result = api.deleteProject(123);
      expect(result).toBeInstanceOf(Promise);
    });
  });
});
