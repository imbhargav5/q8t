import { GMB_API_BASE_URL } from "./config";
import { refreshAccessToken } from "./oauth2";

export interface GMBClientConfig {
  clientId: string;
  clientSecret?: string;
  accessToken: string;
  refreshToken?: string;
...
export function createGMBClient(config: GMBClientConfig): HttpClient {
